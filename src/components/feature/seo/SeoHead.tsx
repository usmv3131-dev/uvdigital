...
export function SeoHead({
  ...
  useEffect(() => {
    ...
    if (html) {
      const lang = (locale || DEFAULT_META.locale).split("_")[0]?.toLowerCase() || "ru";
      html.lang = lang;
    }
    ...
    setMetaProperty("og:locale", locale || "ru_RU");
  ...
  }, [title, description, keywords, canonical, image, locale]);
      ...
      },
      {
        ...
        hasOfferCatalog: {
          ...
          itemListElement: [
            ...
            {
              "@type": "Offer",
              name: "AI-маркетинг под ключ",
              priceCurrency: "RUB",
              price: "45000",
              description: "Маркетинговая стратегия, AI-воронки, аналитика и интеграции с CRM.",
            },
          ],
        },
      },
        ...
        itemListElement: [
          {
            ...
            position: 1,
            name: "Главная",
            item: DEFAULT_META.canonical,
          },
          {
            "@type": "ListItem",
            position: 2,
            name: "Решения",
            item: `${DEFAULT_META.canonical}/#services`,
          },
          {
            "@type": "ListItem",
            position: 3,
            name: "Проекты",
            item: `${DEFAULT_META.canonical}/#projects`,
          },
          {
            "@type": "ListItem",
            position: 4,
            name: "Контакты",
            item: `${DEFAULT_META.canonical}/#contact`,
          },
        ],
      },
    ];
