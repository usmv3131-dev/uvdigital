...
const steps = [
  {
    icon: Search,
    title: 'Discovery и аудит',
    description:
      'Провели интервью с владельцами и администраторами, замерили скорость реакции в каналах, собрали требования к тону и бренду.',
    color: 'from-blue-500 to-cyan-500',
  },
  {
    icon: Settings,
    title: 'Продуктовое проектирование',
    description:
      'Собрали CJM клиента, описали сценарии, подготовили дизайн-платформу и создали набор интентов для AI-агента.',
  ...
  },
  {
    ...
    description:
      'Настроили вебхуки с CRM, подключили мессенджеры, обучили модель на исторических диалогах и прайсах, провели QA.',
  ...
  },
  {
    ...
    description:
      'Запустили пилот, собрали обратную связь, добавили апсейл-сценарии и расширили систему на всю сеть салонов.',
