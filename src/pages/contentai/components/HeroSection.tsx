...
function HeroSectionComponent() {
  ...
  return (
    ...
    >
      ...
      <motion.div 
        className="hidden sm:block absolute inset-0 opacity-30 dark:opacity-20"
        style={{ 
          rotateX,
          rotateY,
      ...
      {/* 3D Floating Orbs */}
      <motion.div
        className="hidden sm:block absolute top-20 left-10 w-64 h-64 bg-gradient-to-br from-blue-400/20 to-cyan-400/20 dark:from-blue-500/30 dark:to-cyan-500/30 rounded-full blur-3xl"
        animate={{
          y: [0, -50, 0],
          x: [0, 30, 0],
          scale: [1, 1.2, 1],
      ...
      <motion.div
        className="hidden sm:block absolute bottom-20 right-10 w-96 h-96 bg-gradient-to-br from-purple-400/20 to-pink-400/20 dark:from-purple-500/30 dark:to-pink-500/30 rounded-full blur-3xl"
        animate={{
          y: [0, 50, 0],
          x: [0, -30, 0],
          scale: [1, 1.1, 1],
